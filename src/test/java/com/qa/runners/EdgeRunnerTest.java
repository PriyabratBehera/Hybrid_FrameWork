...
/**
    ...
    @CucumberOptions(
            plugin = {"pretty",
                    "html:target/Edge/cucumber",
                    "summary",
                    "me.jvt.cucumber.report.PrettyReports:target/Edge/cucumber-html-reports",
...
//        ,dryRun = true
    ...
    public class EdgeRunnerTest extends AbstractTestNGCucumberTests {
